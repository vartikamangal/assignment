...
const Map<String, RapportData> rapportData = {
  'VERY_BAD': RapportData(
    dropPageContent: "Oh, we’re sorry to hear that you’re feeling down. Feeling sad is just part of being human, but usually these feelings pass.",
    feelingPageContent: FeelingPageContent(
      textTop: "Being super-down may feel all-encompassing at times, but you should also have moments when you are able to laugh or be comforted.",
      textMid:
  ...
  'BAD': RapportData(
    ...
    feelingPageContent: FeelingPageContent(
      textTop: "Sadness is an important emotional state that helps us explore our vulnerabilities and be more empathetic to others.",
      textMid:
...
textMid: "Think about it a bit more and tell us if there's anything worrying you right now?",
textBottom:
