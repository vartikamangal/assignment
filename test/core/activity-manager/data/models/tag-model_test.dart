...
void main() {
  final List<TagModel> tTags = <TagModel>[
    // TagModel(
    //   name: "LOSING_TEMPER",
  ...
  group('Model TagModel ', () {
    ...
    // });
    // test('fromJson should transform raw-response into TagModel', () async {
    //   //arrange
    //   final jsonMap =
    //       jsonDecode(fixtureReader(filename: 'raw-tag-model.json')) as List;
    //   //act
    //   final result = jsonMap
    //       .map((area) => TagModel.fromJson(area as Map<String, dynamic>))
    //       .toList();
    //   //assert
    //   expect(result, tTags);
    // });
