...
void main(){
  const List<RecommendationCategory> tRecommendationCategoryModel=<RecommendationCategoryModel>[
  ...
  group('Model RecommendationCategoryModel ', () {
    ...
    test('fromJson should transform raw-response into RecommendationCategoryModel',
            () async {
          //arrange
          final jsonMap =
          jsonDecode(fixtureReader(filename: 'recommendation-category-model.json'))
          as List;
          //act
          final result = jsonMap
              .map((area) =>
              RecommendationCategoryModel.fromJson(area as Map<String, dynamic>))
              .toList();
          //assert
