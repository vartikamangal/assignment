...
class MockGetCategoryActivitiesRepository extends Mock implements GetCategoryActivitiesRepository {}

void main(){
  MockGetCategoryActivitiesRepository repository;
  GetCategoryActivities useCase;
...
const tCategory=RecommendationCategoryModel(
    ...
    Recommendation(
        activity: ActivityRecommendation
         ...
         durationInMinutes: 15,
          ...
          actionTime: "DO_NOW",
          criticality: "LOW",
          categoryVO: RecommendationCategory(id: 1,
          categoryName: "PHYSICAL",
          displayTitle: "Physical",
          displaySubtitle: "Focus on the body",
          categoryDetailedDescription: "This is physical category for body",
  ...
  group('USECASE : getactivity', () {
    test('should return a list of activityCategory using repository', () async {
      ...
      //act
      final result = await useCase(const GetCategoryActivitiesParams(category: tCategory));
      //assert
