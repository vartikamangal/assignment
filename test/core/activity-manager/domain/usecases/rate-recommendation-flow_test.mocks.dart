...
// in tatsam_app_experimental/test/core/activity-manager/domain/usecases/rate-recommendation-flow_test.dart.
...
/// A class which mocks [RateRecommendationFlowService].
///
/// See the documentation for Mockito's code generation for more information.
class MockRateRecommendationFlowService extends _i1.Mock
    implements _i2.RateRecommendationFlowService {
  MockRateRecommendationFlowService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<_i4.Either<_i5.Failure, _i4.Unit>?> rateRecommendation(
          {_i6.FeedbackModel? feedback}) =>
      (super.noSuchMethod(
              Invocation.method(#rateRecommendation, [], {#feedback: feedback}),
